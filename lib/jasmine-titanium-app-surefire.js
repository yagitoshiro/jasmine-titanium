...
Ti.include("/vendor/jasmine-titanium/lib/jasmine.titanium.JUnitXmlReporter.js");
...
jasmine.getEnv().addReporter(new jasmine.TitaniumJUnitXmlReporter(JasmineTitaniumApp.verbose));
