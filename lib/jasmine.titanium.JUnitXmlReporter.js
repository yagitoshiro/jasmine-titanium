(function()
{
	...
	TitaniumJUnitXmlReporter.prototype =
	{
      ...
      //var logDir = Titanium.Filesystem.getFile("./", "test-result");
      // $HOME/.jenkins/jobs/Jasmine-Titanium/logs/
      var logDir = Titanium.Filesystem.getFile("../../../../../../../.jenkins/jobs/Jasmine-Titanium/workspace/", "test-result");
			...
			endFile.write("");
                        Titanium.API.info("Test suite end.");
                },
